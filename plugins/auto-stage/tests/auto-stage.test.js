 ...
 *
 * Run: node --test plugins/auto-stage/tests/auto-stage.test.js
 * Or:  npm test
 */
...
const { isInGitRepo, stageFile } = require('../auto-stage.js');

const SCRIPT_PATH = path.join(__dirname, '../auto-stage.js');
