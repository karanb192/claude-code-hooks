 ...
 *
 * Run: node --test plugins/config-watch/tests/config-watch.test.js
 * Or:  npm test
 */
...
const { evaluate } = require('../config-watch.js');

const SCRIPT_PATH = path.join(__dirname, '../config-watch.js');
