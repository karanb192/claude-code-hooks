 ...
 *
 * Run: node --test plugins/format-code/tests/format-code.test.js
 * Or:  npm test
 */
...
const { getFormatter, formatFile, log, FORMATTERS } = require('../format-code.js');

const SCRIPT_PATH = path.join(__dirname, '../format-code.js');
