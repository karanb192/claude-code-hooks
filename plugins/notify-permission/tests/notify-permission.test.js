 ...
 *
 * Run: node --test plugins/notify-permission/tests/notify-permission.test.js
 * Or:  npm test
 */
...
const {
  ...
  formatMessage,
  sendSlack,
} = require('../notify-permission.js');

const SCRIPT_PATH = path.join(__dirname, '../notify-permission.js');
